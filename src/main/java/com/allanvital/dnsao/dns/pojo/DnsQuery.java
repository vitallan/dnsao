...
public class DnsQuery {
    ...
    public DnsQuery(DnsQueryRequest request, DnsQueryResponse response) {
        this.client = request.getClientAddress().getHostAddress();
        this.source = response.getResponseSource();
        this.response = response.getResponse();
        this.queryResolvedBy = response.getQueryResolvedBy();
    }
