...
public class MovingWindowWithPagingStatsCollectionTest {
    ...
    public void getOrderedQueryEventsOrdersCorrectlyWithinSameBucket() {
        ...
        QueryEvent q1 = new QueryEvent(t("2025-10-02T09:32:00Z"), 100);
        QueryEvent q2 = new QueryEvent(t("2025-10-02T09:34:00Z"), 100);
        QueryEvent q3 = new QueryEvent(t("2025-10-02T09:33:00Z"), 100);
        QueryEvent q4 = new QueryEvent(t("2025-10-02T09:31:00Z"), 100);
    ...
    public void getOrderedQueryEventsOrdersCorrectlyAcrossBucketBoundaries() {
        ...
        QueryEvent q1 = new QueryEvent(t("2025-10-02T09:31:00Z"), 100);
        QueryEvent q2 = new QueryEvent(t("2025-10-02T09:32:00Z"), 100);
        QueryEvent q3 = new QueryEvent(t("2025-10-02T09:36:00Z"), 100);
        QueryEvent q4 = new QueryEvent(t("2025-10-02T09:37:00Z"), 100);
        QueryEvent q5 = new QueryEvent(t("2025-10-02T09:41:00Z"), 100);
        QueryEvent q6 = new QueryEvent(t("2025-10-02T09:46:00Z"), 100);
        QueryEvent q7 = new QueryEvent(t("2025-10-02T09:51:00Z"), 100);
    ...
    public void getOrderedQueryEventsSkipsEmptyBucketsAndStillPaginatesCorrectly() {
        ...
        QueryEvent q1 = new QueryEvent(t("2025-10-02T09:15:00Z"), 100);
        QueryEvent q2 = new QueryEvent(t("2025-10-02T09:32:00Z"), 100);
        QueryEvent q3 = new QueryEvent(t("2025-10-02T09:55:00Z"), 100);
        QueryEvent q4 = new QueryEvent(t("2025-10-02T10:05:00Z"), 100); // still within 60-min window at 10:10
