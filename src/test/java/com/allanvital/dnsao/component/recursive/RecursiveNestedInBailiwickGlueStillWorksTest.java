 ...
 */
public class RecursiveNestedInBailiwickGlueStillWorksTest extends AbstractRecursiveScenarioTest {

    private static final String DOMAIN = "foo.example.com";
    private static final String IN_BAILIWICK_NS_HOST = "ns1.foo.example.com";
    private static final String IN_BAILIWICK_NS_IP = "127.0.0.42";
    private static final String FINAL_IP = "10.0.0.64";
    ...
    @Test
    public void keepsUsingNestedInBailiwickGlueDirectly() throws IOException {
        GlueFixtureHelper fixture = new GlueFixtureHelper(fakeUpstreamServer);
