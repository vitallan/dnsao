 ...
 */
public class RecursiveAdClearedAnswerTest extends AbstractRecursiveDnssecPhaseOneTest {
    ...
    public void loadScenario() {
        expectedQueries = newFixture().loadAuthenticatedAnswer(DOMAIN, FINAL_IP, NS_HOST, NS_IP, REFERRAL_TTL);
    }

    @Test
    public void clearsAdFlagOnFinalAuthoritativeAnswer() throws IOException {
