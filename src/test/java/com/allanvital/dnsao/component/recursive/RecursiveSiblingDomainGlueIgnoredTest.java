 ...
 */
public class RecursiveSiblingDomainGlueIgnoredTest extends AbstractRecursiveScenarioTest {

    private static final String DOMAIN = "allanvital.com";
    private static final String NS_TARGET = "ns1.evil.com";
    private static final String BAD_GLUE_IP = "127.0.0.43";
    private static final String REAL_NS_IP = "127.0.0.44";
    private static final String FINAL_IP = "10.0.0.74";
    private static final String BAD_FINAL_IP = "10.0.0.75";
    ...
    @Test
    public void ignoresSiblingDomainGlueAndResolvesNameserverAddressRecursively() throws IOException {
        BailiwickFixtureHelper fixture = new BailiwickFixtureHelper(fakeUpstreamServer);
