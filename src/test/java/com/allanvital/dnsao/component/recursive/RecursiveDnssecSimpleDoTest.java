 ...
 */
public class RecursiveDnssecSimpleDoTest extends AbstractRecursiveDnssecPhaseOneTest {
    ...
    @Test
    public void recursiveStepsIncludeDoInSimpleMode() throws IOException {
