 ...
 */
public class RecursiveHappyPathWithGlueFixture extends AbstractRecursiveScenarioFixture {

    public RecursiveHappyPathWithGlueFixture(FakeServer fakeServer) {
        super(fakeServer);
    }

    public List<DnsQueryKey> load(String domain, String finalIp, String nsHost, String nsIp, long referralTtl) {
        clearHistory();
        ...
        fakeServer.mockResponse(domainAQuery, MessageHelper.buildAResponse(domainAQuery, finalIp, 60));
