 ...
 */
public class RecursiveCnameToAnswerFixture extends AbstractRecursiveScenarioFixture {

    public RecursiveCnameToAnswerFixture(FakeServer fakeServer) {
        super(fakeServer);
    }

    public List<DnsQueryKey> load(String domain, String aliasTarget, String finalIp, String nsHost, String nsIp, long referralTtl) {
        clearHistory();
        ...
        fakeServer.mockResponse(aliasAQuery, MessageHelper.buildAResponse(aliasAQuery, finalIp, referralTtl));
