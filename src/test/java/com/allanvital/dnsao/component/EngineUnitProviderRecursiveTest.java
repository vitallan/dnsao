 ...
 */
public class EngineUnitProviderRecursiveTest extends TestHolder {
    ...
    @Test
    public void validatedEngineUnitsOrderingInRecursiveMode() {
        ...
        assertInstanceOf(RecursiveUnit.class, engineUnits.get(3));
