 ...
 */
public class RecursiveUnitTimeoutSecondsTest extends AbstractRecursiveUnitTestSupport {
    ...
    public void setup() throws Exception {
        ...
        recursiveUnit = buildRecursiveUnit(
                ...
                new ClockWalkingAuthorityQueryClient(scenario, testTimeProvider, 1200L),
                recursiveConf
        );
    }

    @Test
    public void processShouldServfailWhenTotalRecursiveDeadlineExpires() {
        recursiveConf.setTimeoutSeconds(2);
    ...
    @Test
    public void processShouldSucceedWhenTotalRecursiveDeadlineDoesNotExpire() {
        recursiveConf.setTimeoutSeconds(4);
        recursiveConf.setPerAuthorityTimeoutMillis(2000);
